...
server {
    ...
    server_name wixasset.pointlook.com;
    ...
    root /home/www/wixasset.pointlook.com/public;
    ...
    location = /uploads {
      ...
      if ($request_method = OPTIONS) {
        ...
        add_header Access-Control-Allow-Origin "http://wixasset.pointlook.com";
      ...
      if ($request_method = POST) {
        ...
        upload_add_header Access-Control-Allow-Origin "http://wixasset.pointlook.com";
